	...
	if (node->hasChildNodes()) {
		...
		if (templatePath.indexOf(".iff") < 0) { // Non-item selections
			...
			if (templatePath == "unlearn_all_skills") {
				...
				{
					TransactionLog trx(TrxCode::CHARACTERBUILDER, player, 1000000000, true);
					player->addCashCredits(1000000000, true);
				}
				player->sendSystemMessage("You have received 1,000,000,000 Credits");
